...
function setup() {
  ...
  //꽃입니다.
  flower1 = new Flower(100, 100, 110, 94);
  flower2 = new Flower(40, 200, 67, 57);
  flower3 = new Flower(400, 70, 87, 77);
